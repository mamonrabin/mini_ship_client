...
export const metadata: Metadata = {
  title: "titaswebs | terms & conditions",
      ...
      <div className="Container bg-white py-6">
        <div className="flex flex-col gap-2 lg:gap-4">
          ...
          <div className="policy-page-text">
            titaswebs respects and protects the privacy of our customers and
            users who visit our websites.titaswebs knows that you care how
          ...
          <div>
            ...
            <div className="policy-page-text">
              ...
              titaswebs.com reserves the right to send you certain service
              related communication, considered to be a part of your
              titaswebs.com account without offering you the facility to opt-out.
