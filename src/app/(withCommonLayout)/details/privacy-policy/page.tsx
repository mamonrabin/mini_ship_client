...
export const metadata: Metadata = {
  title: "titaswebs | privacy policy",
      ...
      <div className="Container py-6 bg-white">
        <div className="flex flex-col gap-2 lg:gap-4">
          ...
          <div className="policy-page-text">
            titaswebs respects and protects the privacy of our customers and users
            who visit our websites. titaswebs knows that you care how information
          ...
          <div className="policy-page-text ">
            ...
            the services provided by titaswebs.com you agree to the collection and
            use of your data by titaswebs.com in the manner provided in this Privacy
            Policy.
          </div>
          ...
          <div className="">
            ...
            <ul className="policy-page-text policy-page-li">
              ...
              <li>
                ...
                safety or security of any person, violations of titaswebs.com s terms
          ...
          <div>
            ...
            <div className="policy-page-text">
              ...
              titaswebs.com reserves the right to send you certain service related
              communication, considered to be a part of your titaswebs.com account
          ...
          <div className="policy-page-text">
            ...
            you at any stage want to delete your personal data from titaswebs, across
            all platforms, you have the full right to do so. Please send an
            email to support@titaswebs.com, we will process your request within the
