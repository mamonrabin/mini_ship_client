...
const ShopResponsiveBar = () => {
  ...
  const filterOptions = [
    ...
    },
    {
      id: "2",
      title: "Category",
      options: ["Air Conditioners", "Electronics & Appliances", "Smartphones", "Television", "Washing Machine", "Mobile Accessories", "Watch"],
    },
    
    {
      id: "3",
      title: "Brand",
      options: ["Apple", "Google", "Honer", "HTC", "Infinix", "Nokia", "OnePluse", "Oppo"],
    },
    {
      id: "4",
      title: "Colors",
              ...
              <div className="flex-1 overflow-y-auto px-4 py-6 space-y-4">
                {filterOptions.map((filter) => {
                  ...
                  return (
                    <div
                      key={filter.id}
                      className="relative border-b before:content-[''] before:absolute before:left-1/2 before:bottom-0 before:h-px before:w-0 before:bg-primary/60 before:transition-all before:duration-800 hover:before:left-0 hover:before:w-full"
                    >
                      {/* Accordion Header */}
                      <button
                        onClick={() =>
