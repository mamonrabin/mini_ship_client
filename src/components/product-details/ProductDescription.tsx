...
const ProductDescription = () => {
  ...
  <p
    ...
    className={`w-40 py-4 font-medium flex items-center justify-center rounded cursor-pointer transition
      ${activeTab === "spec"
        ...
        : "text-[#262626]/90 hover:bg-gray-100"}`}
  >
    Specification
  </p>
  ...
  >
    Reviews
      ...
      {/* Specification */}
      <div ref={specRef} className="specification scroll-mt-24">
      ...
      {/* Description */}
      <div ref={descRef} className="description scroll-mt-24">
        ...
        <div className="Container">
          ...
          <div className="mt-3">
            ...
            <div className="text-sm ml-4 mt-2">
              ...
              <li>
                Proper temperature maintenance keeps food fresh.
              </li>
              <li>
                Food-grade Korean resin plastic parts
              </li>
      ...
      {/* Reviews */}
      <div ref={reviewRef} className="review scroll-mt-24">
